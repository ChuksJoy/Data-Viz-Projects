## About the Report
The Power BI report in this repository is a replication of a report that I encountered in a [YouTube tutorial](youtube.com/watch?v=Lub16PueF-8). It is designed to showcase the same data and visualizations as the original report, and it's meant for educational purposes only. The report aims to highlight the following key aspects:
